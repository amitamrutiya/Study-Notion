export default function contactUsEmail (
  ...
  return `<!DOCTYPE html>
    ...
    <body>
        <div class="container">
            <a href="https://studynootion.netlify.app"><img class="logo"
            ...
            <div class="support">If you have any further questions or need immediate assistance, please feel free to reach
                out to us at <a href="mailto:info@studynotion.store">info@studynotion.store</a>. We are here to help!</div>
        </div>
    </body>
