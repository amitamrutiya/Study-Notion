...
function Navbar() {
  ...
  useEffect(() => {
    (async () => {
      setLoading(true);
      try {
        console.log("Fetching Categories... " + categories.CATEGORIES_API);
    ...
    >
      <div className="flex w-11/12 max-w-maxContent items-center justify-between">
        ...
        <div className="hidden items-center gap-x-4 md:flex">
          {user &&
            user?.accountType !== ACCOUNT_TYPE.INSTRUCTOR && ( // if user is present(login) and user is not instructor then we show cart icon in place of login and signup;
